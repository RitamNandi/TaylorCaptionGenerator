...
def upload():
    ...
    if file:
        ...
        closest_lyric, img_bytes = process_image(filename)
        uploaded_image_url = '/uploads/' + file.filename
        return render_template('result.html', closest_lyric=closest_lyric, uploaded_image=uploaded_image_url)
